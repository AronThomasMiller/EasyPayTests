...
namespace EasyPayTests
{
    public class InspectorTest
    {
        ...
        public void SignInInspectorCorrect()
        {
            ...
            var homePage = (HomePageInspector)loginPage.Login("inspector1@gmail.com", "Admin123");
        ...
        public void ScheduleAvailable()
        {
            ...
            welcomePage.Init(driver);
            var loginPage = welcomePage.SignIn();
            var homePageInspector = (HomePageInspector)loginPage.Login("inspector1@gmail.com", "Admin123");
        ...
        public void ScheduleNotAvailable()
        {
            ...
            welcomePage.Init(driver);
            var loginPage = welcomePage.SignIn();
            var homePageUser = (UsersHomePage)loginPage.Login("user1@gmail.com", "Admin123");
